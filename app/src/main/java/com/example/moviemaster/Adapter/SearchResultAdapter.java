...
public class SearchResultAdapter extends RecyclerView.Adapter<SearchResultAdapter.ItemViewHolder> {
  ...
  Context context;
    ...
    public SearchResultAdapter(List<Movie> movieList, Context context) {
    ...
    @NonNull
    @Override
    public SearchResultAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SearchResultAdapter.ItemViewHolder holder, int position) {
